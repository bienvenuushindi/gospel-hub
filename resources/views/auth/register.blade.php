    ...
    <div class="container" style="min-height: 50vh;margin:15vh auto;">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="bg-white">
                    <div
                        class="card-header text-center text-white bg-dark">{{ __('Register') }}</div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row my-5">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($errors->has('country'))
                                        <label for="country"
                                               class="form-label text-danger">{{$errors->first('country')}}</label>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit"
                                            class="btn btn-outline-dark rounded-pill   float-right my-sm-0">
                                        {{ __('Register') }}
                                    </button>
                                </div>
                            </div>
